  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "equalizer-1-mobile":
          "equalizer-mobile 0.7s ease-in-out infinite alternate",
        "equalizer-2-mobile":
          "equalizer-mobile 0.7s ease-in-out infinite alternate 0.15s",
        "equalizer-3-mobile":
          "equalizer-mobile 0.7s ease-in-out infinite alternate 0.3s",
        "equalizer-4-mobile":
          "equalizer-mobile 0.7s ease-in-out infinite alternate 0.45s",
