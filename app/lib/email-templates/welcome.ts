...
<head>
  ...
  <title>Email Notifications Enabled - The Pops Orchestra</title>
</head>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="padding: 32px; text-align: center;">
                    ...
                    <p style="margin: 0 0 8px 0; color: #ff9000; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em;">You're all set</p>
                    <h2 style="margin: 0 0 20px 0; color: #ffffff; font-size: 20px; font-weight: 700;">Automated emails are now live</h2>

                    <p style="margin: 0; color: #94a3b8; font-size: 15px; line-height: 1.7;">
                      This is a confirmation that Resend has been successfully connected to The Pops Orchestra app. You'll now receive automated notifications from the platform directly to this inbox.
                    </p>
