...
export default function ShareButton({ concertId, className }: ShareButtonProps) {
  ...
  return (
    <button
      ...
      className={
        className ||
        'inline-flex items-center justify-center gap-2 px-6 py-4 bg-neutral-800 hover:bg-neutral-700 text-white font-semibold rounded-lg transition-all border border-neutral-700'
      }
    >
      {copied ? (
        <>
