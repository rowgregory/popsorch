    ...
    >
      <div>
        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-3">
            <div>
              ...
              <p className="text-sm text-neutral-400">Analytics & Cloud Platform Access</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 mb-6">
          {/* Analytics ID */}
          <div className="group">
            <label className="text-xs font-medium text-neutral-400 uppercase tracking-wide mb-1 block">
              Analytics ID
            </label>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {copiedEmail ? (
                  ...
                  <Copy className="w-4 h-4 text-neutral-400 group-hover:text-white transition-colors mx-auto" />
                )}
              </button>
            </div>
          </div>
