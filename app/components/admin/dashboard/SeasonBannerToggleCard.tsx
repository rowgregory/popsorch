...
const SeasonBannerToggleCard = () => {
  ...
  const handleToggleVisible = async () => await toggleSeasonPackageBanner({}).unwrap()
  const handleToggleLive = async () => await toggleSeasonPackageBannerLive({}).unwrap()
    ...
    >
      ...
      <div className="mb-4 sm:mb-6">
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-lg sm:text-xl font-bold text-white">Season Package Banner</h3>
          <div
