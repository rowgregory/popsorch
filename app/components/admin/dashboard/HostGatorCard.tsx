  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[#FF7200] hover:bg-[#e56600] text-white font-semibold rounded-lg transition-all shadow-lg shadow-[#FF7200]/20"
      >
        Open HostGator
