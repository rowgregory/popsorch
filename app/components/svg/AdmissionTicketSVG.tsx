...
const AdmissionTicketSVG = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="100%"
      viewBox="0 0 420 100"
      className="max-w-[516px] fill-current stroke-[#d1d1d1] dark:stroke-[#162646]"
    >
      <g clipPath="url(#clip0_3632_1203)">
        <g clipPath="url(#clip1_3632_1203)">
          <path
            className="text-white dark:text-[#0b1628]"
            ...
            strokeWidth="2"
          ></path>
          <line x1="28" y1="49" x2="394" y2="49" strokeWidth="2" strokeDasharray="10 10"></line>
        </g>
      </g>
      <defs>
        ...
        <clipPath id="clip1_3632_1203">
          <rect width="420" height="616" fill="white" transform="translate(0 -419)"></rect>
        </clipPath>
      </defs>
    </svg>
  )
...
export default AdmissionTicketSVG
