...
import LogoWRobyn from './LogoWRobynHeader'
  ...
  return (
    <footer>
      <section className="bg-lavendermist dark:bg-[#080d1a] pl-4 py-14 md:px-12 md:py-24 w-full">
        <div className="max-w-[516px] 760:max-w-[700px] 990:max-w-[960px] 1200:max-w-[1160px] 1400:max-w-1320 w-full mx-auto relative grid grid-cols-12 gap-y-16 430:gap-x-12">
          ...
          <div className="col-span-12 flex flex-col gap-y-2 pb-10 pt-7 items-center justify-center">
            ...
            >
              <span className="group relative inline-block">
                ...
                <span className="absolute left-0 right-0 group-hover:translate-y-0 translate-y-12 duration-150 text-white">
                  Join Now
                </span>
              </span>
      ...
      <section className="p-4 md:p-12">
        <div className="max-w-[516px] 760:max-w-[700px] 990:max-w-[960px] 1200:max-w-[1160px] 1400:max-w-1320 w-full mx-auto flex flex-col 430:flex-row items-center justify-center 430:justify-between text-lg font-semibold text-mutedslate">
