...
const LineUpBlock = () => {
  ...
  return (
    <div className="bg-lavendermist dark:bg-shadowblue px-4 py-14 md:px-12 md:py-24">
      <div className="max-w-[516px] md:max-w-[700px] 990:max-w-[960px] 1200:max-w-[1160px] 1400:max-w-1320 w-full mx-auto relative grid grid-cols-12 gap-y-16 990:gap-x-16 items-end">
        <div className="col-span-12 990:col-span-4">
          ...
          <p className="text-lg text-slategray dark:text-slatemist font-medium 990:mt-6 leading-snug">
            Experience an electrifying mix of talent, from vocalists to musicians. Each performer brings passion, energy, and unforgettable
            artistry.
          </p>
        ...
        <div className="col-span-12 990:col-span-8 flex flex-col gap-y-10">
          ...
          <div className="flex items-center w-full">
            <div className="flex flex-1 items-center gap-x-3 mr-10">
              <ChevronLeftSVG onClick={() => (isFirstSlide ? () => {} : moveToSlide('prev'))} isFirstSlide={isFirstSlide} />
              <ChevronRightSVG
