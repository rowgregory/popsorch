...
import { resetCampSuccess, setStep } from '@/app/redux/features/campSlice'
...
import { useCreateCampApplicationMutation } from '@/app/redux/services/campApi'
import Spinner from '@/app/components/common/Spinner'
import LogoWRobyn from '@/app/components/LogoWRobynHeader'
import { increaseCampApplicationsCount } from '@/app/redux/features/appSlice'
import validateCampAppStepFourForm from '@/app/lib/validations/validateCampAppStepFourForm'
import { ArrowLeft } from 'lucide-react'
import { sendAdminPushNotification } from '@/app/actions/sendAdminPushNotification'
  ...
  const handleStepFour = async (e: FormEvent) => {
    ...
    try {
      ...
      await createCampApplication(campForm?.inputs)
        .unwrap()
        .then(async () => {
          await sendAdminPushNotification('New camp application submitted', 'Camp Application Alert')
