...
export function SeasonDates() {
  ...
  const { scrollYProgress } = useScroll({
    target: hydrated ? heroRef : undefined,
    ...
    <section className="bg-black text-white overflow-hidden">
      ...
      <div className="relative min-h-[70vh] flex flex-col items-center justify-center px-4 py-24 text-center overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            backgroundImage: 'url(/images/nikki-fire.jpg)',
        ...
        <div className="relative z-10">
          <motion.p
            ...
            className="font-changa text-[10px] uppercase tracking-[0.4em] text-blaze mb-6"
          >
            2026–2027 Season
          </motion.p>
          ...
          {CONCERTS.map((concert) => (
            <div key={concert.name} className="relative overflow-hidden bg-black group aspect-3/4">
              <Picture
                ...
                alt={concert.name}
                priority
                className="object-cover h-full w-full opacity-70 group-hover:opacity-90 group-hover:scale-105 transition-all duration-700"
              />
      ...
      <div className="border-t border-white/10 px-4 990:px-8 py-16 990:py-24 max-w-5xl mx-auto">
        ...
        >
          <p className="font-changa text-[9px] uppercase tracking-[0.35em] text-blaze mb-3">Mark Your Calendar</p>
