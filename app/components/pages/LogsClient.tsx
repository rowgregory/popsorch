          ...
          (
            ...
            return (
              <motion.div
                ...
                className="bg-linear-to-br from-neutral-900 to-black border border-neutral-800 rounded-xl hover:border-neutral-700/70 transition-all duration-300 shadow-xl overflow-hidden"
              >
                {/* Log Row */}
                <div
