  ...
  return (
    <>
      ...
      <section className="px-4 990:px-12 xl:px-4">
        <div className="max-w-[520px] 760:max-w-screen-576 990:max-w-[800px] 1200:max-w-screen-1160 1590:max-w-screen-1400 w-full mx-auto grid grid-cols-12 990:gap-x-7 pt-32 pb-44">
          <div className="order-2 1200:order-1 col-span-12 1200:col-span-9 flex flex-col items-center gap-y-7">
            {loading ? (
          ...
          <form className="1200:sticky 1200:top-[58px] order-1 1200:order-2 col-span-12 1200:col-span-3 mb-12 1200:mb-0 flex flex-col gap-y-4 gap-x-2 w-full bg-duskgray p-9 h-fit">
